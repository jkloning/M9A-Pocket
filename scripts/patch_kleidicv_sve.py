...
背景见 MAA-Meow issue #202：KleidiCV 在库初始化时按 HWCAP2_SVE2 在 NEON / SVE2 实现间二选一
...
# OpenCV 4.12.0 + KleidiCV 0.5.0 实测门控点数量
# MaaFramework 5.12.3（M9A-Pocket v4.7.2 所带 libopencv_world4.so）与该组合一致
DEFAULT_EXPECT = 15
